...
CREATE TABLE usersdb.application_user (
...
CREATE TABLE usersdb.roles_users (
...
INSERT INTO usersdb.application_user(id,email,first_name,last_name,password,user_name)
VALUES("1","admin@movies.com","Fernando","Lucas","$2a$10$Tra2wfz3ZZod1m8F.WhFlOF3dfgL6pr85puJHwZ87Hju8IIuBr9JC","admin");

INSERT INTO usersdb.roles_users
(users_id,
roles_id
)
VALUES
